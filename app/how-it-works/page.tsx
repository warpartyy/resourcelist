...
export default function HowItWorksPage() {
  return (
    <Container>
      ...
      <h1 className="text-4xl font-semibold tracking-tight text-text-primary pt-8 mb-2">
        How It Works
      </h1>

      <p className="text-text-muted max-w-3xl mb-10">
...
<div className="mt-16 text-sm text-text-subtle">
