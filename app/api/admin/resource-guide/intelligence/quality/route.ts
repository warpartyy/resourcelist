...
import { getResourceGuideQualityReport } from "@/lib/services/resources/ai/intelligence/reporting/quality";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const data = await getResourceGuideQualityReport(filters);
